 ...
 *      Author: ldea
 */
#include "PlayerStateHandlerServer.hh"

string PlayerStateHandlerServer::stateToString(PlayerState aState)
{
	switch(aState)
	{
...
PlayerState PlayerStateHandlerServer::stringToState(string aState)
{
...
int PlayerStateHandlerServer::getDestinationWidth(PlayerState aState)
{
	switch(aState)
	{
		case STATE_WALKINGRIGHT:
...
int PlayerStateHandlerServer::getDestinationHeight(PlayerState aState)
{
	switch(aState)
	{
		case STATE_WALKINGRIGHT:
