...
MessageServer::MessageServer(MsgDestHeader header1, MsgCmdHeader header2, std::string param1, std::string param2, std::string param3, std::string param4)
{
...
MessageServer::MessageServer(MsgDestHeader header1, MsgCmdHeader header2, int param1, int param2, int param3, int param4)
{
