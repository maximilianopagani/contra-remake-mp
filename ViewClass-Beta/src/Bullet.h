...
class Bullet
{
	...
	private:
		...
		int pos_x, pos_y, // Posicion absoluta con respecto al mapa gigante.
			speed_x, speed_y, // Velocidad que avanza en cada coordenada en cada update
			max_travel_distance, traveled_distance; // Gestion de la vida de la bala segun su distancia viajada
};
